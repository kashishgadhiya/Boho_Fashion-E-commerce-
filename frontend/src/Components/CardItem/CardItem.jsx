...
const CardItem = () => {
  ...
  return (
    <div className=' mx-auto max-w-3xl mt-10'>
        ...
        {all_product.map((i)=>{
            if(cartItems[i.id]>0){
                return <div className='flex gap-6 lg:my-5 m-6 flex-wrap '>
             ...
             <div className='flex gap-3  border-2 px-2 py-1'>
                ...
                <img src={delete_icon} width={25} height={10}   onClick={()=>{removeFromCart(i.id)}} className='mt-1 cursor-pointer'></img>
        ...
        <div className='lg:my-6 m-6 mt-10'> 
            ...
            {/* <button  className='py-2 text-white  px-2 my-4 mx-20 lg:mx-0' style={{backgroundColor:'#a00220'}} onClick={Checkouthandler({name:})}> PROCEED TO CHECKOUT</button> */}
            <button  className='py-2 text-white  px-2 my-4 mx-20 lg:mx-0' style={{backgroundColor:'#a00220'}} onClick={
                ()=>
                
                alert("Thank you for Shopping")}> PROCEED TO CHECKOUT</button>
